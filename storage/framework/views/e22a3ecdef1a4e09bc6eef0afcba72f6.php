...
<head>
  ...
  <style>
    .header-animated {
      background: url('<?php echo e(asset('images/image.png')); ?>') no-repeat center center / cover;
      min-height: 500px;
      position: relative;
    }
    .header-overlay {
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <a class="navbar-brand p-0 me-3" href="#">
            <img src="<?php echo e(asset('images/logorapp.png')); ?>" alt="Logo" width="125" height="90">
        </a>
          ...
          <div class="container">
            ...
            <div class="row align-items-center">
              <div class="col-md-4 text-center mb-4">
                <img src="<?php echo e(asset('images/pimpinan.png')); ?>" alt="Foto Pimpinan" class="img-fluid rounded shadow" style="max-width: 300px;">
...
<?php /**PATH D:\Semester 6\Tugas Akhir TA\Sistem-Pengajuan-Proposal\resources\views/welcome.blade.php ENDPATH**/ ?>