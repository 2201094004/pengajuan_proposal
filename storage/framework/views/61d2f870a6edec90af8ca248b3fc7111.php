...
<script>
    ...
    const labelsKabupaten  = <?php echo json_encode($labelsKabupaten); ?>;
    const dataProposal     = <?php echo json_encode($jumlahProposalPerKabupaten); ?>;
    ...
    const dataJenis    = <?php echo json_encode($jumlahPerJenisProposal); ?>;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Semester 6\Tugas Akhir TA\Sistem-Pengajuan-Proposal\resources\views/stakeholder/dashboard.blade.php ENDPATH**/ ?>